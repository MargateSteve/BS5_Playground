...
class SiteSettings
{
    ...
    public static function css ($custom) {
        $sheets = [
            // Locally Hosted
            'local' => [
                'admin' => '<link rel="stylesheet" type="text/css" href="../basic-dashboard.css">',
                'vendors' => [
                ],
            ],
            // Remotely Hosted
    ...
    public static function js ($custom) {
        $files = [
            // Locally Hosted
            'local' => [
                'admin' => '<script src="../basic-dashboard.js" type="text/javascript"></script>',
                'chartdata' => '<script src="../chartdata.js" type="text/javascript"></script>',
                'vendors' => [
                ],
            ],
            // Remotely Hosted
            'remote' => [
                ...
                // Chart Js
                'chart-js' => '<script src="https://cdn.jsdelivr.net/npm/chart.js@2.9.4/dist/Chart.min.js" integrity="sha384-zNy6FEbO50N+Cg5wap8IKA4M/ZnLJgzc6w2NqACZaK0u0FXfOWRRJOnQtpZun8ha" crossorigin="anonymous"></script>',
